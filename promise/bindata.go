...
func jsBundleJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "js/bundle.js", size: 6067, mode: os.FileMode(420), modTime: time.Unix(1443815886, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
